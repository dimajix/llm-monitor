...
import { mdiMagnify, mdiMessageTextOutline, mdiArrowLeft, mdiHistory, mdiAccount, mdiRobot, mdiSourceBranch, mdiThemeLightDark, mdiMemory, mdiTimerOutline, mdiContentCopy, mdiCog, mdiChatOutline, mdiAutoFix, mdiRobotIndustrial } from '@mdi/js'
